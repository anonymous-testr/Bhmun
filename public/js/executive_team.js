...
function nextSlide( n) {
    document.getElementById( "slideB").style.backgroundImage = "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2) ), url('res/slides/organization_team/" + slideIndex + ".jpeg')";
    document.getElementById( "slideF").style.opacity = "0";
...
function loadSlide( n, reset) {
    ...
    document.getElementById( "slideF").style.backgroundImage = "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2) ), url('res/slides/organization_team/" + slideIndex + ".jpeg')";
